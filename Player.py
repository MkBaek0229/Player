class Player:
    ...
    @classmethod
    def tick(cls,tick_count,pos_x,pos_y):
        global inst

        if tick_count == 0: #게임 시작 시점
            inst = Player.create(Player("a",x=0,y=0,hp=3))
        elif
...
"""
    ...
    def get_vision(self):
        ...
        return self.vision
"""
    # 갑옷 아이템 착용 함수 None: 기본 314: 천갑옷, 315: 가죽갑옷, 316:판금갑옷 event_code: 311
